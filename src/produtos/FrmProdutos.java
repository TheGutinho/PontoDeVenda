...
public class FrmProdutos extends javax.swing.JInternalFrame {
    ...
    public FrmProdutos() {
     ...
     void atualizarDados() {
        ...
        estoque.setText(tabela.getValueAt(linha, 4).toString());
    }
    ...
    private void initComponents() {
        ...
        estoque = new app.bolivia.swing.JCTextField();
        ...
        jPanel2.add(nome, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 30, 180, -1));
        ...
        estoque.setBackground(new java.awt.Color(34, 102, 145));
        ...
        estoque.setPhColor(new java.awt.Color(255, 255, 255));
        estoque.setPlaceholder("ESTOQUE");
        ...
        jPanel2.add(estoque, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 180, -1));

        nomeL.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/produtos/nomeL.png"))); // NOI18N
        jPanel2.add(nomeL, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 20, 250, 52));
        ...
        jPanel2.add(tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, 183, -1));
        ...
        jPanel2.add(tipoL, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 20, -1, 52));
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "TIPO PRODUTO", "NOME DO PRODUTO", "PREÇO", "ESTOQUE"
            }
        ) {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "OPÇÕES", 0, 0, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "BUSCAR", 0, 0, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    private void estoqueKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_estoqueKeyTyped

    }//GEN-LAST:event_estoqueKeyTyped
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
          if (selecionarRegistro) {
            ...
            else if (!nome.getText().matches("[a-zA-ZÀ-ÿ\\s]+")) {
                JOptionPane.showMessageDialog(this, "O campo nome deve conter apenas letras.", "Erro", JOptionPane.ERROR_MESSAGE);
            } 
        // Verifica se o campo 'idade' contém apenas números
            else if (!valor.getText().matches("\\d+") || !estoque.getText().matches("\\d+")) {
                JOptionPane.showMessageDialog(null, "O campo preco/estoque deve conter apenas números.", "Erro", JOptionPane.ERROR_MESSAGE);
            } 
            else {
                produtos.Produtos prod = new Produtos();
                prod.setPrimaryKey(codigo.getText());
                prod.setTipo(tipo.getSelectedItem().toString());
                prod.setNome(nome.getText()); 
                prod.setEstoque(estoque.getText());
                prod.setValor(valor.getText());               
                int op = ProdutosSql.registrar(prod);
                if (op != 0) {
        ...
        if (tabela.getRowCount() > 0) {
            if (tabela.getSelectedRowCount() > 0) {
                ...
                if (codigo.getText().equals("") || nome.getText().equals("") 
                        || tipo.getSelectedItem().equals("TIPO PRODUTO") || valor.equals("") || estoque.equals("")) {
                    ...
                    prod.setEstoque(estoque.getText());
                    prod.setValor(valor.getText());                    
                    int opc = ProdutosSql.atualizar(prod);
                    if (opc != 0) {
                        String id = codigo.getText();
                        limparCampos();
                        selecionarLinha(id);
    ...
    private app.bolivia.swing.JCTextField estoque;
