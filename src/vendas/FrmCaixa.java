...
import static principal.MenuPrincipalP.carregador;
import produtos.FrmListaProd;
import produtos.ProdutosSql;
...
//    }
    ...
    public FrmCaixa() {
        ...
        recebido.getDocument().addDocumentListener(new DocumentListener() {
            @Override
    ...
    private void initComponents() {
        ...
        recebido.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                recebidoPropertyChange(evt);
            }
        });
        ...
        jPanel4.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 230, 80, 30));

        codigoL3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/vendas/total.png"))); // NOI18N
        jPanel4.add(codigoL3, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 220, 150, 50));
    ...
    private void buscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscaActionPerformed
            ...
            if( principal.MenuPrincipal.carregador != null){
               principal.MenuPrincipal.carregador.add(lista); 
            }
            
            if(principal.MenuPrincipalP.carregador != null){
               principal.MenuPrincipalP.carregador.add(lista);
            }
    ...
    private void venderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_venderActionPerformed
        if (tabela.getRowCount() < 1) {
            ...
            int codigoColIndex = modelo.findColumn("CÓDIGO");
            int quantidadeColIndex = modelo.findColumn("QUANTIDADE");            

            int rowCount = modelo.getRowCount();

            for (int row = 0; row < rowCount; row++) {
                Object quantidadeValue = modelo.getValueAt(row, quantidadeColIndex);
                Object codigoValue = modelo.getValueAt(row, codigoColIndex);

                ProdutosSql.atualizarEstoque(quantidadeValue.toString(), codigoValue.toString());               
            }
    ...
    private void recebidoPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_recebidoPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_recebidoPropertyChange
